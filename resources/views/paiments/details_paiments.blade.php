    ...
    <div class="page-header">
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="title">
                    <h4>details paiments</h4>
                </div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">details paiments</li>
                    </ol>
                </nav>
            </div>
...
@endforeach
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-blue h4">details paiments</h4>

                    </div>

                </div>
                <form action="/details/traitment" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" type="number" id="avance" name="avance" value="{{$paiments->avance}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">date de avance</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" type="date" id="date_avance" name="date_avance" value="{{$paiments->date_avance}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">reste</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" type="number"  id="reste" name="reste"  value="{{$paiments->reste}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">date de reste</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" type="date"  id="date_reste" name="date_reste"  value="{{$paiments->date_reste}}">
                        </div>
                    </div>
                    <div class="form-group row">
