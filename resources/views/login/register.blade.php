				...
				<div class="col-md-6 col-lg-5">
					<div class="register-box bg-white box-shadow border-radius-10">
						<div class="wizard-content">
							<form class="tab-wizard2 wizard-circle wizard" action="/register/traitment" method="POST">
								@csrf
		...
		<div class="modal-dialog modal-dialog-centered max-width-400" role="document">
			<div class="modal-content">
				<div class="modal-body text-center font-18">
					...
					Your confirmation is crucial in maintaining accurate records and providing you with the best possible service. If any of the details are incorrect or need updating, please let us know as soon as possible.
				</div>
				<div class="modal-footer justify-content-center">
					<button type="submit"  href="/login" class="btn btn-primary">Done</button>
				</div>
			</div>
		</div>
	</div>
