													...
													<div class="profile-task-list pb-30">
														...
														<ul>
															<li>
																...
																{{$task->message}}
																<div class="task-assign">{{$task->assigned}} <div class="due-date">due date <span>{{$task->date}}</span>
																	<a class="btn btn-sm btn-danger" href="/delete_task/{{$task->id}}">X</a>
													...
													<ul class="profile-edit-list row">
														<li class="weight-500 col-md-6">
															...
															<div class="form-group">
																...
																<input class="form-control form-control-lg" type="text" placeholder="{{auth()->user()->name}}">
															</div>
															<div class="form-group">
																<label>email</label>
																<input class="form-control form-control-lg" type="email" placeholder="{{auth()->user()->email}}">
															</div>
															<div class="form-group">
																<label>title</label>
																<input class="form-control form-control-lg" type="text" placeholder="Dr">
															</div>
															<div class="form-group">
																<label>Date of birth</label>
																<input class="form-control form-control-lg date-picker" type="text" placeholder="23/04/1880">
															</div>
															<div class="form-group">
																<label>Gender</label>
																<div class="d-flex">
															...
															<div class="form-group">
																...
																<input class="form-control form-control-lg" type="text" placeholder="fez">
															</div>
															<div class="form-group">
																<label>Postal Code</label>
																<input class="form-control form-control-lg" type="text" placeholder="2345">
															</div>
															<div class="form-group">
																<label>Phone Number</label>
																<input class="form-control form-control-lg" type="text" placeholder="0643656562">
															</div>
															<div class="form-group">
																<label>Address</label>
																<textarea class="form-control" placeholder="fez"></textarea>
															</div>
															<div class="form-group">
